...
class ResNet(nn.Module):
    def __init__(self, block, layers, image_size, return_fm=False):
        ...
        self.conv1 = nn.Conv2d(3, 64, kernel_size=7, stride=2, padding=3,
                               bias=False)
#         self.bg_conv = nn.Conv2d(3, 64, kernel_size=7, stride=2, padding=3,
#                                bias=False)
...
#         self.avgpooling = nn.AvgPool2d(image_size[0] // (2 ** 5), stride=1)
    ...
    def forward(self, x, x_bg=None):  # x:image y:ingredient
...
def resnet34(image_size, pretrained=False, return_fm=False, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [3, 4, 6, 3], image_size, return_fm=return_fm, **kwargs)
    pretrained = True
...
def resnet101(image_size, pretrained=False, return_fm=False, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 23, 3], image_size, return_fm=return_fm, **kwargs)
    pretrained =  True
    if pretrained:
    ...
    return model
def resnet152(image_size, pretrained=False, return_fm=False, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 8, 36, 3], image_size, return_fm=return_fm, **kwargs)
    pretrained = True
    if pretrained:
